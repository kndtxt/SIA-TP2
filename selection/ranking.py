...
def calculate_population_ranking_pseudo_fitness(geneticAlgorithm: GeneticAlgorithm, population: List[Individual]):
...
def selection_ranking(geneticAlgorithm: GeneticAlgorithm, population: List[Individual], quantity: int) -> List[Individual]:
